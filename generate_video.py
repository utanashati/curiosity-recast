...
if __name__ == "__main__":
    ...
    parser.add_argument("--fps", "-fps", default=35, type=int)
    ...
    game.replay_episode(args.recording_file, args.player)
    ...
    if save_as_video:
        ...
        video_writer = cv2.VideoWriter(video_name, fourcc, 35.0, (frame_width, frame_height))
